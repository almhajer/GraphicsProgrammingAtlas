(function (global) {
  ...
  const UI_SEGMENT_SOURCES = Object.freeze({
    ...
    tutorialSupportRuntime: {path: 'js/modules/tutorial-support.js', format: 'script'},
    fileSourceViewerRuntime: {path: 'js/modules/file-source-viewer.js', format: 'script'},
    heavyHelper4Runtime: {path: 'js/modules/app-heavy-reference-helpers-4-runtime.js', format: 'script'},
    ...
    cppReferenceEnrichment: {path: 'data/ui/cpp-reference-enrichment.json', format: 'json'},
