  ...
  const FALLBACK_CPP_HOME_CONFIG = Object.freeze({
    ...
    sections: Object.freeze([
      Object.freeze({
        ...
        iconType: 'macro',
        tokens: Object.freeze(['auto', 'const', 'constexpr', 'nullptr'])
      }),
      Object.freeze({
        key: 'types',
        ...
        iconType: 'structure',
        tokens: Object.freeze(['std::string', 'std::string_view', 'std::span', 'std::optional'])
      }),
      Object.freeze({
        ...
        iconType: 'function',
        tokens: Object.freeze(['std::vector', 'std::array', 'std::sort', 'std::move'])
      }),
      Object.freeze({
        key: 'io-and-errors',
        ...
        iconType: 'variable',
        tokens: Object.freeze(['std::cout', 'std::cerr', 'std::endl', 'std::exception'])
      }),
      Object.freeze({
